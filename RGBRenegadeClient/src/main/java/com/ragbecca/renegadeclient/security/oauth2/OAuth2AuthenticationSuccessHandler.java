...
import com.ragbecca.renegadeclient.config.AppProperties;
...
import com.ragbecca.renegadeclient.util.CookieUtils;
...
import static com.ragbecca.renegadeclient.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        final User user = userRepository.findByUsername(authentication.getName()).get();
